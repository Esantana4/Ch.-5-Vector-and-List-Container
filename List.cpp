...
//postcondition: going to then use ifstream to read, open the text, push_front the information
...
//precondition: going to call the data list
//postcondition: going to then check if data empty,if not popping back the front element using pop_front()
...
//precondition: going to call the list vector
...
//precondition: going to read from file
//postcondition: going to then use ifstream to read, open the text, NOW push_back the information
...
//precondition: going to call the data list
//postcondition: going to returns an iterator pointing to the first element in the list
...
//precondition: going to call the data list
//postcondition: going to return iterator begin() and end() returns all elements in the list
...
//precondition: going to call the data list
//postcondition: going to returns a reverse iterator pointing to the last element in the list
...
//precondition: going to call the data list
//postcondition: going to returns a reverse iterator pointing to the theoretical element preceding the first element in the list
...
//precondition: going to call the data list
//postcondition: going to use iterator rbegin() and rend() returns all elements in the list
...
//precondition: going to call the data list
//postcondition: going to return the removing from the list a single element(using an iterator)
...
//precondition: going to call the data list
//postcondition: going to return the removes from the list a range of elements(using iterators)
...
//precondition: going to call the data list
//postcondition: going to return the content (exchange) of the container by another list's content of the same type
void List::swapList() {
...
//precondition: going to call the data list
//postcondition: going to return the list in sorted
void List::sortList() {
    //check if list is empty, if empty, send a warning
    if (data.empty()) {
        cout << "\n\t\tThe list is empty.\n\n";
