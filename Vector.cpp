...
//precondition: going to call the data vector
//postcondition: going to requests to reserve vector capacity be at least enough to contain n elements. Reallocation happens if there is need of more space.
...
//precondition: going to call the data vector
//postcondition: going to resizes the container so that it contains n(n will be our output) elements.
...
//postcondition: going to then use ifstream to read, open the text, push_back the information, then print it out 
...
//precondition: going to pass in the filename argument (parameter)
...
//precondition: going to call the data vector
//postcondition: going to then check if data empty,if not popping back the last element using pop_back()
...
//precondition: going to call the data vector
//postcondition: going to check if empty first, if not then look for the front element, use .front()
...
//precondition: going to call the data vector
//postcondition: going to check if empty first, if not then look for the back element, use .back()
...
//precondition: going to call the data vector
//postcondition: going to returns a reference to the element at position n in the vector
void Vector::lookForIndex() {
    ...
    //gives me the range of the elements
...
//precondition: going to call the data vector
//postcondition: going to returns an iterator pointing to the first element in the vector
...
//precondition: going to call the data vector
//postcondition: going to returns an iterator referring to the past-the-end element in the vector
...
//precondition: going to call the data vector
//postcondition: going to return iterator begin() and end() returns all elements in the vector
...
//precondition: going to call the data vector
//postcondition: going to returns a reverse iterator pointing to the last element in the vector
...
//precondition: going to call the data vector
//postcondition: going to returns a reverse iterator pointing to the theoretical element preceding the first element in the vector
...
//precondition: going to call the data vector
//postcondition: going to use iterator rbegin() and rend() returns all elements in the vector
...
//precondition: going to call the data vector
//postcondition: going to return the removing from the vector a single element(using an iterator)
...
//precondition: going to call the data vector
//postcondition: going to return the removes from the vector a range of elements(using iterators)
